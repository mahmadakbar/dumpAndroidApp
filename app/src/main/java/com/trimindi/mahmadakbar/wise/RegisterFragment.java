...
public class RegisterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDisplayName = mRegisterView.findViewById(R.id.register_name_input_text);
        mEmail = mRegisterView.findViewById(R.id.register_email_input_text);
        mPassword = mRegisterView.findViewById(R.id.register_password_input_text);
        mCreateBtn = mRegisterView.findViewById(R.id.register_btn);
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    mRegProgress.hide();
                    Toast.makeText(getActivity(), "Cannot Sign in. Please check the form and try again.", Toast.LENGTH_LONG).show();
